package com.wildcodeschool.example.challengeHibernateExample.utils;

import com.wildcodeschool.example.challengeHibernateExample.entities.User;
import com.wildcodeschool.example.challengeHibernateExample.repositories.UserDao;
...
public class Outputter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User("Joséphine", "Wildeuse", 25);
        LOG.info("******************");
        ...
        User user2 = new User("Lilia", "Wildeuse", 24);
        LOG.info("******************");
